...
nonisolated struct ScannerPreferences: Sendable {
    ...
    static func load(
        ...
        ScannerPreferences(
            ...
            maxConcurrentHosts: loadInt(
                key: AppPreferenceKeys.maxConcurrentHosts,
                defaultValue: AppPreferenceDefaults.maxConcurrentHosts,
                from: defaults
            ),
            maxConcurrentPortsPerHost: loadInt(
                key: AppPreferenceKeys.maxConcurrentPortsPerHost,
                defaultValue: AppPreferenceDefaults.maxConcurrentPortsPerHost, from: defaults
            )
        )
    }
